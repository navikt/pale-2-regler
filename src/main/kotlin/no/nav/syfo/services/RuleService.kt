...
class RuleService(
    ...
    suspend fun executeRuleChains(receivedLegeerklaering: ReceivedLegeerklaering): ValidationResult = with(GlobalScope) {
        ...
        val doctorSuspend = legeSuspensjonClient.checkTherapist(
            ...
            DateTimeFormatter.ISO_DATE.format(receivedLegeerklaering.legeerklaering.signaturDato)).suspendert
        ...
        val results = listOf(
            ValidationRuleChain.values().executeFlow(legeerklaring, RuleMetadata(
